...
DOMCustomMatchers.toHaveComputedStyle = function(util){
	return util.dom.returnBlock(function(o,not){
		var elem = o[0], prop = o[1], val = o[2], pseudoEl = o[3], elemValid, domValid, propValid, strValid, regValid, valid, propHyphen, propCamel, cssObject, cssValue, propTest, valTest, pass, msgDOM, msgProp, msgCssValue, msgVal, msg;
		elemValid = util.dom.isHTML(elem);
		...
		cssObject = elemValid&&domValid&&propValid ? window.getComputedStyle(elem,pseudoEl):cssObject;
